...
const { execScript, cname, createFiles, Registry } = require('../utils');
const questions = {
  name: {
    type: 'input',
    name: 'name',
...
module.exports = async ctx => {
  ...
  commonQuestions.push(questions.env, questions.mode, questions.framework, questions.socket, questions.setup);
  ...
  fields.socket = commonStep.socket;
  ...
  if (fields.socket) modules.push('@reinjs/rein-socket');
  ...
  files.push({
    file: path.resolve(projectDictionary, 'package.json'),
